{
	...
	"patches": {
		...
		"explode_effect_opacity": "(Testing stage) Changes the opacity of eff_deadcircle (enemy explosion effect).",
		"knives_from_alcostg": "(Testing stage) Changes the knife bullet graphics into that of Uwabami Breakers (a.k.a alcostg).",
		"seEoSD": "(th07-) Changes most of the sound effects into EoSD style (if that SE existed in EoSD). Note that se_kira00.wav may not be properly heard.",
		...
		"th185_Bule": "(th185) (Temporary patch) Fixes the 'FairyWave Rainy Bule' typo."
	},
	"servers": [
